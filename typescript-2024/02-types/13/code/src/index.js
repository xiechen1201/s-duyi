...
const person1 = { name: 'jack', score: 100 };
const person2 = { name: 'jack', age: 18, subject: 'math' };
const person3 = { name: 'jack', age: 18, subject: 'math', score: 100 };
const person4 = { name: 'jack' }; // error
